...
import Floating from "../../../asset/Floating.svg"
import Arx from "../../../asset/Arx.svg"
...
const B2icon = require("../../../asset/NeoClassic.png");
...
const batteryData = [
  {
    img: BackImg,
    imgTitle: "Designed to turn on",
    imgsubtitle: "Even when switched off",
    cardData: [
      {
        id: 1,
        imgIcon: Neo,
        cardtitle: "BEAUTIFUL",
        exshowroomprice: "Neo-",
        exshowroomrange: "Classic",
      },
      {
        id: 2,
        imgIcon: Floating,
        cardtitle: "INNOVATIVE",
        exshowroomprice: "Floating",
        exshowroomrange: "Design"
      },
      {
        id: 3,
        imgIcon: Arx,
...
export default function Design({}) {
  ...
  //  useEffect(()=>{
  //   onScreen && setStateScroll("Design")
    ...
    <>
      {batteryData?.map((i) => (
        <MainDiv
          ...
          //  ref={ref}
        >
          <DivSecond className="design-container">
            {/* <Img1 src={i?.img} /> */}
            <DivTop>
              <div>
                <HeadingHead
