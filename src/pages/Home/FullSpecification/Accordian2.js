...
import Spz3 from "../../../asset/spacesPer1.png";
          ...
          <Div1>
            ...
            <SubDiv2 style={{ color: "#fff" }}>
              <SecondDiv>
                ...
                <SubDiv2P2>
                  {/* {testRide?.warrentyOptions}  */}
                  <p>Top Speed</p>  <img src={Icon1} />
                  </SubDiv2P2>
                  <SubDiv2P2>
                  {/* {testRide?.warrentyOptions}  */}
                  <p>Range</p>   <img src={Icon2} />
                  </SubDiv2P2>
                  <SubDiv2P2>
                  {/* {testRide?.warrentyOptions}  */}
                  <p>Acceleration</p>   <img src={Icon3} />
                  </SubDiv2P2>
              </SecondDiv>
              {/* <DivIcon>
            ...
            <SubDiv3>
              <SubDivBottom style={{ color: "#fff", position: "relative",width:"100%",marginBottom:"10px" }}>
                <img
                  src={B1sticon}
             ...
             <Para2 style={{display:"flex",alignSelf:"flex-start",}}>
              ...
              <Para2 style={{display:"flex",alignSelf:"flex-start"}}>
                {/* {testRide?.size2} */}
                330Nm Torque <br/>on wheel
                </Para2>
                {/* <Para1>{testRide?.bottomHeading2}
                </Para1> */}
              </div>
              </SubDivBottom>
            </SubDiv3>
