...
import FullBattery from "../../../asset/FullBattery.svg";
...
const BatteryIcon = require("../../../asset/WMotor.png");
const B2icon = require("../../../asset/fa_battery-2.png");
const B3icon = require("../../../asset/WService.png");
...
//  useEffect(()=>{
//   onScreen && setStateScroll("Service&Warranty")

// },[onScreen])
  return (
    <>
      {warrentyData?.map((i) => (
        <MainDiv className="tiktok" id="Service&Warranty"
        //  ref={ref}
         >
          <DivSecond className="warrenty-container">
            {/* <Img1 src={i?.img} /> */}
           <DivTop>
            <div>
            <HeadingHead
