...
const batteryData = [
  {
    img: BackImg,
    imgTitle: "Stay Safe",
    imgsubtitle: "No matter where you Rorr",
    cardData: [
      {
        id: 1,
        imgIcon: Alert,
...
export default function Safety({}) {
  ...
  //  useEffect(()=>{
  //   onScreen && setStateScroll("Safety")

  // },[onScreen])
  return (
    <>
      {batteryData?.map((i) => (
        <MainDiv className="tiktok" id="Safety" ref={ref}>
          <DivSecond className="safety-containerNew">
            {/* <Img1 src={i?.img} /> */}
            <DivTop>
              <div>
                <HeadingHead
