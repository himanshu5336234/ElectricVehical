...
function BookingCheckOtp({openOtp,setOpenOtp,phoneNumber,setOpenBnf}) {
    ...
    setOtpExpire(initialValue)
     ...
     if(!res.data.error){
      ...
      if(res.data.bookData._id){
        console.log("We have sent a verification code on your phone number +91 ")
  ...
  return (
    <div style={{display:openOtp?"":"none",position:'absolute', zIndex:"2"}}>
    <motion.div 
     animate={{
    ...
    className='otp-container'>
      ...
      <div className='otp-top'>
        ...
        <div className='otp-top-otplabel'>
          ...
          <span className='otp-top-info'>We have sent a verification code on your phone number +91 {phoneNumber}</span>
        </div>
      </div>
