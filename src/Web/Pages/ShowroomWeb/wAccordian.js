...
import BookingNotFound from "../../Components/ObenEvNotAvailable/WobenEvNotAvailable"
import Modal from "../../Components/Modal/Moodal";
import Wschedule from "../ScheduleWeb/wSchedule";
...
export default function ControlledAccordions(props) {
  ...
  React.useEffect(() => {
    const fetchShowroomData = async () => {
      setIsLoading(true)
      try {
        const resSr = await publicRequest.post("user/get-showrooms",{city:props.userInfo.city});
      ...
      (show?.map((i,index) => (
        ...
        >
          ...
          <AccordionDetails>
            ...
            {modalState && <Modal closeModal={setModalState}><Wschedule i={i} props={props} /></Modal>}
